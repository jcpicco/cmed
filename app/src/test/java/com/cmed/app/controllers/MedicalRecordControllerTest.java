...
import com.medcentermanager.app.mappers.medicalRecords.*;
...
class MedicalRecordControllerTest {
    ...
    @Nested
    @DisplayName("GET /api/medical-records - Get All MedicalRecords")
    class GetAllMedicalRecordsTests {
        ...
        void getAllMedicalRecords_whenMedicalRecordsExist_returnsList() throws Exception {
            ...
            mockMvc.perform(get("/api/medical-records"))
                    ...
                    .andExpect(jsonPath("$[0].background").value(medicalRecord.getBackground()))
                    .andExpect(jsonPath("$[1].background").value(medicalRecord2.getBackground()));
    ...
    @Nested
    @DisplayName("GET /api/medical-records/{id} - Get MedicalRecord by ID")
    class GetMedicalRecordByIdTests {
        ...
        void getMedicalRecordById_whenValidId_returnsMedicalRecord() throws Exception {
            ...
            mockMvc.perform(get("/api/medical-records/{id}", medicalRecord.getId()))
                    .andExpect(status().isOk())
                    .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        void getMedicalRecordById_whenInvalidUUID_returns400() throws Exception {
            mockMvc.perform(get("/api/medical-records/{id}", "invalid-uuid"))
    ...
    @Nested
    @DisplayName("POST /api/medical-records - Create MedicalRecord")
    ...
    @Nested
    @DisplayName("PATCH /api/medical-records/{id} - Update MedicalRecord")
    class UpdateMedicalRecordTests {
        ...
        void updateMedicalRecord_withValidData_returnsUpdatedMedicalRecord() throws Exception {
            ...
            mockMvc.perform(patch("/api/medical-records/{id}", medicalRecord.getId())
                            .contentType(MediaType.APPLICATION_JSON)
        ...
        void updateMedicalRecord_withInvalidUUID_returns400() throws Exception {
            mockMvc.perform(patch("/api/medical-records/{id}", "invalid-uuid")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(medicalRecord)))
                    .andExpect(status().isBadRequest());
    ...
    @Nested
    @DisplayName("DELETE /api/medical-records/{id} - Delete MedicalRecord")
    class DeleteMedicalRecordTests {
        ...
        void deleteMedicalRecord_whenExists_returnsNoContent() throws Exception {
            ...
            mockMvc.perform(delete("/api/medical-records/{id}", medicalRecord.getId()))
        ...
        void deleteMedicalRecord_withInvalidUUID_returns400() throws Exception {
            mockMvc.perform(delete("/api/medical-records/{id}", "invalid-uuid"))
                    .andExpect(status().isBadRequest());
    ...
    class EdgeCasesTests {
        ...
        void updateMedicalRecord_withNullValues_shouldHandle() throws Exception {
            ...
            mockMvc.perform(patch("/api/medical-records/{id}", medicalRecord.getId())
                    ...
                    .andExpect(jsonPath("$.background").isEmpty());

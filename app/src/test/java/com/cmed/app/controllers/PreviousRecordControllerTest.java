...
import com.medcentermanager.app.exceptions.PreviousRecordNotFoundException;
import com.medcentermanager.app.mappers.previousRecords.*;
import com.medcentermanager.app.models.PreviousRecord;
import com.medcentermanager.app.models.Patient;
import com.medcentermanager.app.repositories.PreviousRecordRepository;
...
class PreviousRecordControllerTest {
    ...
    @Nested
    @DisplayName("GET /api/previous-records - Get All PreviousRecords")
    class GetAllPreviousRecordsTests {
        ...
        void getAllPreviousRecords_whenPreviousRecordsExist_returnsList() throws Exception {
            ...
            mockMvc.perform(get("/api/previous-records"))
    ...
    @Nested
    @DisplayName("GET /api/previous-records/{id} - Get PreviousRecord by ID")
    class GetPreviousRecordByIdTests {
        ...
        void getPreviousRecordById_whenValidId_returnsPreviousRecord() throws Exception {
            ...
            mockMvc.perform(get("/api/previous-records/{id}", previousRecord.getId()))
                    .andExpect(status().isOk())
                    .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        void getPreviousRecordById_whenInvalidUUID_returns400() throws Exception {
            mockMvc.perform(get("/api/previous-records/{id}", "invalid-uuid"))
    ...
    @Nested
    @DisplayName("POST /api/previous-records - Create PreviousRecord")
    class CreatePreviousRecordTests {
        ...
        void createPreviousRecord_withValidData_returnsCreatedPreviousRecord() throws Exception {
            ...
            mockMvc.perform(post("/api/previous-records")
    ...
    @Nested
    @DisplayName("PATCH /api/previous-records/{id} - Update PreviousRecord")
    class UpdatePreviousRecordTests {
        ...
        void updatePreviousRecord_withValidData_returnsUpdatedPreviousRecord() throws Exception {
            ...
            mockMvc.perform(patch("/api/previous-records/{id}", previousRecord.getId())
                            .contentType(MediaType.APPLICATION_JSON)
        ...
        void updatePreviousRecord_withInvalidUUID_returns400() throws Exception {
            mockMvc.perform(patch("/api/previous-records/{id}", "invalid-uuid")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(previousRecord)))
                    .andExpect(status().isBadRequest());
    ...
    @Nested
    @DisplayName("DELETE /api/previous-records/{id} - Delete PreviousRecord")
    class DeletePreviousRecordTests {
        ...
        void deletePreviousRecord_whenExists_returnsNoContent() throws Exception {
            ...
            mockMvc.perform(delete("/api/previous-records/{id}", previousRecord.getId()))
        ...
        void deletePreviousRecord_withInvalidUUID_returns400() throws Exception {
            mockMvc.perform(delete("/api/previous-records/{id}", "invalid-uuid"))
                    .andExpect(status().isBadRequest());

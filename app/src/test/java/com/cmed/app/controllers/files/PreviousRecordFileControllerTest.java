package com.medcentermanager.app.controllers.files;

import com.medcentermanager.app.dtos.files.PreviousRecordFileDto;
import com.medcentermanager.app.exceptions.PreviousRecordFileNotFoundException;
import com.medcentermanager.app.models.files.PreviousRecordFile;
import com.medcentermanager.app.models.PreviousRecord;
import com.medcentermanager.app.services.files.PreviousRecordFileService;
import com.medcentermanager.app.handlers.FileExceptionHandler;
...
class PreviousRecordFileControllerTest {
    ...
    @Nested
    @DisplayName("GET /api/previous-records/{previousRecordId}/files")
    class GetAllFilesTests {
        ...
        void shouldReturnListOfFiles() throws Exception {
            ...
            mockMvc.perform(get("/api/previous-records/{previousRecordId}/files", previousRecord.getId())
    ...
    @Nested
    @DisplayName("POST /api/previous-records/{previousRecordId}/files")
    class CreateFileTests {
        ...
        void shouldCreateFile() throws Exception {
            ...
            mockMvc.perform(multipart("/api/previous-records/{previousRecordId}/files", previousRecord.getId())
                            .file(mockFile)
    ...
    @Nested
    @DisplayName("DELETE /api/previous-records/{previousRecordId}/files/{fileId}")
    class DeleteFileTests {
        ...
        void shouldDeleteFile() throws Exception {
            ...
            mockMvc.perform(delete("/api/previous-records/{previousRecordId}/files/{fileId}",

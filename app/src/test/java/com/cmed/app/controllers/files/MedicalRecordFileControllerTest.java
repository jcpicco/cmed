...
import com.medcentermanager.app.services.files.MedicalRecordFileService;
...
class MedicalRecordFileControllerTest {
    ...
    @Nested
    @DisplayName("GET /api/medical-records/{medicalRecordId}/files")
    class GetAllFilesTests {
        ...
        void shouldReturnListOfFiles() throws Exception {
            ...
            mockMvc.perform(get("/api/medical-records/{medicalRecordId}/files", medicalRecord.getId())
    ...
    @Nested
    @DisplayName("POST /api/medical-records/{medicalRecordId}/files")
    class CreateFileTests {
        ...
        void shouldCreateFile() throws Exception {
            ...
            mockMvc.perform(multipart("/api/medical-records/{medicalRecordId}/files", medicalRecord.getId())
                            .file(mockFile)
    ...
    @Nested
    @DisplayName("DELETE /api/medical-records/{medicalRecordId}/files/{fileId}")
    class DeleteFileTests {
        ...
        void shouldDeleteFile() throws Exception {
            ...
            mockMvc.perform(delete("/api/medical-records/{medicalRecordId}/files/{fileId}",
